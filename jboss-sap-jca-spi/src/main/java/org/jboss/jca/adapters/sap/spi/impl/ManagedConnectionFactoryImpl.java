...
public class ManagedConnectionFactoryImpl implements ManagedConnectionFactory {
	...
	public ManagedConnection createManagedConnection(Subject subject, ConnectionRequestInfo cxRequestInfo)
		...
		if (cxRequestInfo != null)
			cri.addProperties((ConnectionRequestInfoImpl) cxRequestInfo);
	...
	public String getPingOnCreate() {
		return defaultConnectionRequestInfo.getProperty(ConnectionRequestInfoImpl.JSJC_PING_ON_CREATE, "true");
	}
	...
	public void setPingOnCreate(String pingOnCreate) {
		defaultConnectionRequestInfo.setProperty(ConnectionRequestInfoImpl.JSJC_PING_ON_CREATE, pingOnCreate);
	}
