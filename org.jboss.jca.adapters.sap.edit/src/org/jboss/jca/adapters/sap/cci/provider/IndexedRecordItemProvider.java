 ...
 * @generated
 */
public class IndexedRecordItemProvider
	 ...
	 * @generated
	 */
	public IndexedRecordItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_IndexedRecord_recordName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_IndexedRecord_recordName_feature", "_UI_IndexedRecord_type"),
				 CciPackageImpl.Literals.INDEXED_RECORD__RECORD_NAME,
				 true,
				 false,
				 false,
	...
	protected void addRecordShortDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_IndexedRecord_recordShortDescription_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_IndexedRecord_recordShortDescription_feature", "_UI_IndexedRecord_type"),
				 CciPackageImpl.Literals.INDEXED_RECORD__RECORD_SHORT_DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This returns IndexedRecord.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/IndexedRecord"));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(IndexedRecord.class)) {
