 ...
 * @version $Id: $
 */
public class JBossSAPResourceAdapter implements ResourceAdapter {

	/** The logger */
	private static Logger log = Logger.getLogger("JBossSAPResourceAdapter");

	/** Destination Provider for JCo runtime. */
	private final JBossDestinationDataProvider destinationDataProvider;

	/**
	 * Default constructor
	 */
	public JBossSAPResourceAdapter() {
		destinationDataProvider = new JBossDestinationDataProvider();
	}
	...
	JBossDestinationDataProvider getDestinationDataProvider() {
