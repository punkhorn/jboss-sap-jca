...
public class RemoveInteractionCommand extends ChangeCommand {
	...
	public RemoveInteractionCommand(EditingDomain domain, Connection owner, EStructuralFeature feature, Collection<?> collection) {
		super(owner);
		this.domain = domain;
		this.owner = owner;
