...
/**
 * This is the item provider adapter for a {@link org.jboss.jca.adapters.sap.model.cci.Connection} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConnectionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Connection_state_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Connection_state_feature", "_UI_Connection_type"),
				 CciPackage.Literals.CONNECTION__STATE,
				 false,
				 false,
				 false,
	...
	protected void addConnectionNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Connection_connectionName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Connection_connectionName_feature", "_UI_Connection_type"),
				 CciPackage.Literals.CONNECTION__CONNECTION_NAME,
				 false,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CciPackage.Literals.CONNECTION__INTERACTIONS);
		}
	...
	public String getText(Object object) {
		String label = ((Connection)object).getConnectionName();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CciPackage.Literals.CONNECTION__INTERACTIONS,
				 CciFactory.eINSTANCE.createInteraction()));
	}
