...
public class TestConnectionImpl {
	...
	private ManagedConnection mockManagedConnection;
	...
	public void testGetProperties() throws ResourceException {
		...
		// When
		ConnectionSpec aConnectionSpec = connection.getConnectionSpec();
		
		// Then
		assertThat("ConnectionImpl.getProperties() returned connection spec different from one used to initialize connection", aConnectionSpec, is(mockConnectionSpec));
	}
