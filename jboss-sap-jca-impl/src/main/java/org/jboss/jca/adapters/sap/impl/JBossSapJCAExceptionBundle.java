 ...
 *
 */
@MessageBundle(projectCode = "JBossSapJCA")
public interface JBossSapJCAExceptionBundle {
	JBossSapJCAExceptionBundle EXCEPTIONS = Messages.getBundle(JBossSapJCAExceptionBundle.class);
