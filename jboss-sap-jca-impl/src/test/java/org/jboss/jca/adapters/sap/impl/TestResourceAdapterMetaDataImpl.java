...
import static org.jboss.jca.adapters.sap.impl.ResourceAdapterMetaDataImpl.RESOURCE_ADAPTER_INTERACTION_SPECS_SUPPORTED_PROP;
import static org.jboss.jca.adapters.sap.impl.ResourceAdapterMetaDataImpl.RESOURCE_ADAPTER_META_DATA_PROPERITES_FILE;
import static org.jboss.jca.adapters.sap.impl.ResourceAdapterMetaDataImpl.RESOURCE_ADAPTER_NAME_PROP;
import static org.jboss.jca.adapters.sap.impl.ResourceAdapterMetaDataImpl.RESOURCE_ADAPTER_SHORT_DESCRIPTION_PROP;
import static org.jboss.jca.adapters.sap.impl.ResourceAdapterMetaDataImpl.RESOURCE_ADAPTER_SPEC_VERSION_PROP;
import static org.jboss.jca.adapters.sap.impl.ResourceAdapterMetaDataImpl.RESOURCE_ADAPTER_SUPPORTS_EXECUTE_WITH_INPUT_AND_OUTPUT_RECORD_PROP;
import static org.jboss.jca.adapters.sap.impl.ResourceAdapterMetaDataImpl.RESOURCE_ADAPTER_SUPPORTS_EXECUTE_WITH_INPUT_RECORD_ONLY_PROP;
import static org.jboss.jca.adapters.sap.impl.ResourceAdapterMetaDataImpl.RESOURCE_ADAPTER_SUPPORTS_LOCAL_TRANSACTION_DEMARCATION_PROP;
import static org.jboss.jca.adapters.sap.impl.ResourceAdapterMetaDataImpl.RESOURCE_ADAPTER_VENDOR_NAME_PROP;
import static org.jboss.jca.adapters.sap.impl.ResourceAdapterMetaDataImpl.RESOURCE_ADAPTER_VERSION_PROP;
...
public class TestResourceAdapterMetaDataImpl {
	...
	private ResourceAdapterMetaDataImpl resourceAdapter;
	
	@Before
	public void setUp() throws Exception {
		// Given
		resourceAdapter = ResourceAdapterMetaDataImpl.INSTANCE;
	}
