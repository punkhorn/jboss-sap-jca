...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>spi</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class SpiExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.spi"));
				ConnectionRequestInfo root = SpiFactory.eINSTANCE.createConnectionRequestInfo();
